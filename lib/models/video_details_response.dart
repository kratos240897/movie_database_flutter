class VideoDetailsResponse {
  ...
  late final int id;
  late final List<VideoResults> results;
  
  VideoDetailsResponse.fromJson(Map<String, dynamic> json){
    id = json['id'];
    results = List.from(json['results']).map((e)=>VideoResults.fromJson(e)).toList();
  }
